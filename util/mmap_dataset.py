...
# https://github.com/EleutherAI/pythia/blob/ef5682374122c227c2d4a4cbab7999ff96127bbf/utils/mmap_dataset.py
# __getitem__ is modified to return a 1D array of tokens without reshaping
...
class MMapIndexedDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        if isinstance(idx, int):
            ...
            # return np_array.reshape(-1, 2049)  # removed for block-transformer
            return np_array
